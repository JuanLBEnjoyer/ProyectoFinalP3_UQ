...
public class Usuario implements Serializable {
    ...
    public Usuario(String idUsuario, String nombreCompleto, String correo, String telefono, String direccion) {
        if (idUsuario == null || idUsuario.isEmpty()) {
            throw new DatosInvalidosException("El id del usuario no puede estar vacío");
        }
    ...
    public void setSaldoTotal(double saldoTotal) {
        if (saldoTotal < 0) {
            throw new DatosInvalidosException("El saldo total no puede ser negativo");
        }
    ...
    public Cuenta obtenerCuenta(String idCuenta) {
        ...
        throw new DatosInvalidosException("Cuenta no encontrada con el ID: " + idCuenta);
    }
    ...
    public void agregarPresupuesto(Presupuesto presupuesto) {
        if (presupuesto != null) {
            ...
            throw new DatosInvalidosException("El presupuesto no puede ser nulo");
        }
    }
    ...
    public double consultarMontoGastado(String idPresupuesto) {
        ...
        throw new DatosInvalidosException("Presupuesto no encontrado con el ID: " + idPresupuesto);
    }
    ...
    public void categorizarTransaccion(String idTransaccion, Categoria categoria) {
        ...
        throw new DatosInvalidosException("Transacción no encontrada con el ID: " + idTransaccion);
    }
